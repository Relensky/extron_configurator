...
bool Win32Window::Create(const std::wstring& title,
  ...
  // Keep the window on the screen. The size is in logical pixels, so display
  // scaling makes it bigger: 1280x720 at 125% is 1600x900, taller and wider
  // than a 1366x768 laptop screen (and too tall for a 1600x900 one once the
  // taskbar is taken off), which opened the app with its bottom and right
  // edge out of sight. Fit it into the monitor's work area instead.
