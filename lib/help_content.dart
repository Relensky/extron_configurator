...
const List<HelpTopic> kHelpTopics = [
  ...
  HelpTopic(
    ...
    body:
        ...
        'THE FOLDER THOSE DRIVERS COME FROM is named at the top of the '
        'editor and can be changed there - it is the same Python Modules '
        'Path App Config carries, so the whole app follows it. A short '
        'list, or a driver that is not in it at all, is usually the app '
        'reading the wrong folder rather than a driver with no block.\n\n'
  ...
  HelpTopic(
    ...
    body:
        ...
        'The camera button at the top takes a picture of the whole timeline '
