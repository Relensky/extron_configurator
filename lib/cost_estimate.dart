...
///      labour hours, cable, plates, anything not a device on the canvas.
...
class CostEstimate {
  ...
  bool get isComplete => unpricedLines == 0;
}
...
CostEstimate computeRoomCost({
  ...
  final subtotal = _cents(equipmentTotal + extrasTotal);
  ...
  final taxableBase = _cents(equipmentTotal + taxableExtras + taxableFees);
