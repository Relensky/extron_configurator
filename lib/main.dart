...
class RoomConfigApp extends StatelessWidget {
  ...
  /// its own accent swatch. Each style also takes an optional secondary
  /// element color ('' = Auto, let the theme derive it).
  static ThemeData themeFor(String style, bool isDark, String classicColor,
      String aurisColor, String classicSecondary, String aurisSecondary) {
    switch (style) {
      case 'auris':
        ...
        // Optional secondary: overrides the scheme slots that standard
        // Material elements read (Auris's own bespoke widgets keep their
        // baked-in slate secondary).
        if (aurisSecondary.isNotEmpty) {
          final Color sec = parseHexColor(aurisSecondary);
...
class AccentColorPicker extends StatelessWidget {
  ...
  /// 'aurisColor' | 'classicSecondary' | 'aurisSecondary'.
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        // --- SECONDARY ELEMENT COLOR (optional, Auto = theme-derived) ---
        Text(
            provider.themeStyle == 'auris'
                ? 'Auris Secondary Color (other elements)'
                : 'Classic Secondary Color (other elements)',
            style: Theme.of(context).textTheme.titleSmall),
        const SizedBox(height: 4),
        Text(
          provider.themeStyle == 'auris'
              ? 'Colors the secondary slots used by standard Material elements. Auto keeps the Auris slate.'
