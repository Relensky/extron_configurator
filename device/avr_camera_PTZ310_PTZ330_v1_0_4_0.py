...
class DeviceSerialClass:
    def __init__(self):
        ...
        self.Commands = {
            ...
            'AutoExposure': { 'Status': {}, 'AllowedValues': ['Full Auto', 'Iris Priority', 'Shutter Priority', 'Manual']},
            ...
            'PanTilt': {'Parameters':['Pan Speed', 'Tilt Speed'], 'Status': {}, 'AllowedValues': ['Up', 'Down', 'Left', 'Right', 'Up Left', 'Up Right', 'Down Left', 'Down Right', 'Stop']},
            ...
            'WhiteBalance': { 'Status': {}, 'AllowedValues': ['Auto', 'Indoor', 'Outdoor', 'One Push', 'Manual']},
            'Zoom': {'Parameters':['Zoom Speed'], 'Status': {}, 'AllowedValues': ['Tele', 'Wide', 'Stop']},
        }
    ...
    def SetIris(self, value, qualifier):
        ...
        if value in ValueStateValues:
            IrisCmdString = self._DeviceID + b'\x01\x04\x0B' + ValueStateValues[value] + b'\xFF'
    ...
    def SetPanTilt(self, value, qualifier):
        ...
        if 1 <= int(qualifier['Pan Speed']) <= 24 and 1 <= int(qualifier['Tilt Speed']) <= 24 and value in ValueStateValues:
            PanTiltCmdString = self._DeviceID + b'\x01\x06\x01' + bytes([int(qualifier['Pan Speed']), int(qualifier['Tilt Speed'])]) + ValueStateValues[value] + b'\xFF'
...
class DeviceEthernetClass:
    ...
    def SetAutoFocus(self, value, qualifier):
        ...
        if value in ValueStateValues:
            AutoFocusCmdString = self.SetHeader(self._DeviceID + b'\x01\x04\x38' + ValueStateValues[value] + b'\xFF')
            self.__SetHelper('AutoFocus', AutoFocusCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetAutoFocus')
    ...
    def SetIris(self, value, qualifier):
        ...
        if value in ValueStateValues:
            IrisCmdString = self.SetHeader(self._DeviceID + b'\x01\x04\x0B' + ValueStateValues[value] + b'\xFF')
            self.__SetHelper('Iris', IrisCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetIris')
