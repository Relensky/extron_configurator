...
class DeviceClass:
    def __init__(self):
        ...
        self.Commands = {
            ...
            'AspectRatio': { 'Status': {}, 'AllowedValues': ['Normal', 'Full', 'Wide', 'Zoom', 'Dynamic', '1:1']},
            'AudioMute': { 'Status': {}, 'AllowedValues': ['On', 'Off']},
            'AutoImage': { 'Status': {}},
            'Input': { 'Status': {}, 'AllowedValues': ['DisplayPort 1', 'DisplayPort 2', 'HDMI 1', 'HDMI 2', 'HDMI 3', 'MP', 'Option']},
            'PictureMode': { 'Status': {}, 'AllowedValues': ['sRGB', 'Adobe RGB SIM', 'DCI SIM', 'REC-Bt709', 'High Bright', 'Full', 'DICOM SIM', 'Programmable 1', 'Programmable 2']},
