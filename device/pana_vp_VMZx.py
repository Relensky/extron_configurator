...
class DeviceSerialClass:
    def __init__(self):
        ...
        self.Models = {
            ...
            'PT-VMZ50U': self.pana_1_5905_B,
            'PT-VMZ50': self.pana_1_5905_B
        }
        ...
        self.Commands = {
            ...
            'Input': { 
                'Status': {}, 
                'AllowedValues': ['Computer 1', 'Computer 2', 'HDMI 1', 'HDMI 2', 'Network/USB', 'Network', 'Memory Viewer', 'Digital Link']
            },
            'Keypad': { 'Status': {}},
...
class DeviceEthernetClass:
    def __init__(self):
        ...
        self.Commands = {
            ...
            'Input': { 
                'Status': {}, 
                'AllowedValues': ['Computer 1', 'Computer 2', 'HDMI 1', 'HDMI 2', 'Network', 'Network/USB', 'Memory Viewer', 'Digital Link']
            },
            'LampUsage': { 'Status': {}},
            'Power': { 'Status': {}, 'AllowedValues': ['On', 'Off']},
