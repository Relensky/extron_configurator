...
DEVICE_INFO = {
    ...
    "models": ["SMP 351", "SMP 351 3G-SDI", "SMP 352", "SMP 352 3G-SDI"],
    "connection": {
        "com_type": "Network",
        "protocol": "SSH",
        "net_port": 22023,
...
class DeviceClass:
    def __init__(self):
        ...
        self.Commands = {
            ...
            'AspectRatio': {'Parameters': ['Input'], 'Status': {}, 'AllowedValues': ['Fill', 'Follow', 'Fit']},
            'AudioBitrate': {'Status': {}, 'AllowedValues': ['80', '96', '128', '192', '256', '320']},
            'AudioInputGain': {'Parameters': ['Type'], 'Status': {}},
            'AudioLevel': {'Parameters': ['L/R'], 'Status': {}},
            'AudioMuteInput': {'Parameters': ['Type', 'Channel', 'L/R'], 'Status': {}, 'AllowedValues': ['On', 'Off']},
            'AudioMuteOutput': {'Parameters': ['L/R'], 'Status': {}, 'AllowedValues': ['On', 'Off']},
            'AudioOnlyRecording': {'Status': {}, 'AllowedValues': ['Enable', 'Disable']},
            'AutoImage': {'Parameters': ['Channel'], 'Status': {}},
            'BackgroundImageCommand': {'Status': {}},
            'BackupRTMPStatus': {'Parameters': ['Stream'], 'Status': {}},
            'BitrateControl': {'Parameters': ['Stream'], 'Status': {}, 'AllowedValues': ['VBR', 'CVBR', 'CBR']},
            'ChapterMarker': {'Status': {}},
            'ClearActiveAlarms': {'Status': {}},
            'CPUUsage': {'Status': {}},
            'CurrentRecordingDuration': {'Status': {}},
            'DelayedRecordingDuration': {'Status': {}},
            'DualChannelHDMIOutput': { 'Status': {}, 'AllowedValues': ['Channel A Fullscreen', 'Channel B Fullscreen', 'Confidence Layout']},
            'EjectUSBStorage': {'Status': {}},
            'Encoder': {'Status': {}, 'AllowedValues': ['Composite', 'Dual']},
            'ExecutiveMode': {'Status': {}, 'AllowedValues': ['Off', 'Complete Lock Out', 'Menu Lock Out', 'Recording Control Only']},
            ...
            'HDMIAudioMute': {'Status': {}, 'AllowedValues': ['On', 'Off']},
            'HDMIVideoMute': {'Status': {}, 'AllowedValues': ['On', 'Off']},
            'HorizontalVideoMirroring': {'Parameters': ['Input'], 'Status': {}, 'AllowedValues': ['On', 'Off']},
            'Input3Format': {'Status': {}, 'AllowedValues': ['YUVp/HDTV', 'YUVi', 'Composite']},
            'InputA': {'Status': {}},
            'InputB': {'Status': {}},
            'InputStatus': {'Status': {}},
            ...
            'RCP101ExecutiveMode': {'Status': {}, 'AllowedValues': ['On', 'Off']},
            ...
            'Record': {'Status': {}},
            'RecordControl': {'Status': {}, 'AllowedValues': ['Enable', 'Disable', 'Enable Dual']},
            'RecordDestination': {'Status': {}, 'AllowedValues': ['Auto', 'Internal', 'USB (Front)', 'USB (Rear)', 'Internal + USB Front', 'Internal + USB Rear', 'Internal + USB RCP', 'Internal + Auto']},
            'RecordDualControl': {'Status': {}, 'AllowedValues': ['On', 'Off']},
            'RecordExtend': {'Status': {}},
            'RecordingMode': {'Status': {}, 'AllowedValues': ['Audio and Video', 'Video Only']},
            'RecordingStartCountdown': {'Status': {}},
            'RecordingVideoFrameRate': {'Parameters': ['Stream'], 'Status': {}},
            'RecordResolution': {'Parameters': ['Stream'], 'Status': {}, 'AllowedValues': ['480p', '720p', '1080p', '512x288', '1024x768', '1280x1024', 'Custom']},
            ...
            'RTMPStream': {'Parameters': ['Stream'], 'Status': {}, 'AllowedValues': ['Enable', 'Disable']},
            'RTSPStreamURL': {'Parameters': ['Stream'], 'Status': {}},
            'SMPRecordingFolderShare': {'Status': {}, 'AllowedValues': ['Enable', 'Disable']},
            'StreamControl': {'Parameters': ['Stream'], 'Status': {}, 'AllowedValues': ['Enable', 'Disable']},
            'StreamingPresetsName': {'Parameters': ['Preset'], 'Status': {}},
            'SwapWindows': {'Status': {}},
            'ThumbnailSize': {'Status': {}, 'AllowedValues': ['Default', 'Archived Resolution']},
        ...
        self.lastRecordingUpdate = {'Destination': 0, 'DestinationSetting': 0}
        self.lastRemainingUSBUpdate = {'Front': 0, 'Rear': 0, 'RCP': 0}
        self.lastAlarmUpdate = 0
        self.lastRemainingRecordTimeUpdate = 0
        self.lastAudioLevelUpdate = 0        

        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'[78]Rpr(\d{1,2})\r\n'), self.__MatchActiveLayoutPreset, None)
            self.AddMatchString(re.compile(b'9Rpr(\d{1,2})\r\n'), self.__MatchActiveLayoutPresetConfidenceDual, None)
    ...
    def UpdateAudioLevel(self, value, qualifier):
        ...
        if qualifier['L/R'] in ['Left', 'Right']:
            ...
            self.Discard('Device Is Busy for UpdateAudioLevel')
    ...
    def UpdateFileDestination(self, value, qualifier):
        ...
        if qualifier['Drive'] in ['Primary', 'Secondary']:
            ...
            self.Discard('Device Is Busy for UpdateFileDestination')
