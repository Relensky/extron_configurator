...
class DeviceClass:
    def __init__(self):
        ...
        self.Commands = {
            ...
            'Focus': {'Parameters':['Focus Speed'], 'Status': {}, 'AllowedValues': ['Far', 'Near', 'Stop']},
            'Home': { 'Status': {}},
            'Iris': { 'Status': {}, 'AllowedValues': ['Up', 'Down', 'Reset']},
    ...
    def UpdateBackLight(self, value, qualifier):
        ...
        print('PTZ Optics NDI 30X Camera res: {}'.format(res))
        if res:
            try:
                value = ValueStateValues[res[2]]
                print('PTZ Optics NDI 30X Camera Value: {}'.format(value))
