...
class DeviceClass:
    def __init__(self):
        ...
        self.Commands = {
            ...
            'AutoAnswerMode': {'Parameters': ['Line'], 'Status': {}, 'AllowedValues': ['Disable', 'Delay', 'Follow SIP Header']},
            'AutomixerGateSet': {'Parameters': ['Input'], 'Status': {}, 'AllowedValues': ['Enable', 'Disable']},
            'AutomixerGateStatus': {'Parameters': ['Input'], 'Status': {}},
            'AuxInputGain': {'Parameters': ['Input'], 'Status': {}},
            'AuxInputMute': {'Parameters': ['Input'], 'Status': {}, 'AllowedValues': ['On', 'Off']},
            'AuxInputPremixerGain': {'Parameters': ['Input'], 'Status': {}},
            'AuxInputPremixerMute': {'Parameters': ['Input'], 'Status': {}, 'AllowedValues': ['On', 'Off']},
            'AuxOutputGain': {'Parameters': ['Output'], 'Status': {}},
            'AuxOutputMute': {'Parameters': ['Output'], 'Status': {}, 'AllowedValues': ['On', 'Off']},
            ...
            'DoNotDisturb': {'Parameters': ['Line'], 'Status': {}, 'AllowedValues': ['Disable', 'Enable']},
            'ExpansionBusMixpointGain': {'Parameters': ['Input', 'Output'], 'Status': {}},
            'ExpansionBusMixpointMute': {'Parameters': ['Input', 'Output'], 'Status': {}, 'AllowedValues': ['On', 'Off']},
            'ExpansionInputPremixerGain': {'Parameters': ['Input'], 'Status': {}},
            'ExpansionInputPremixerMute': {'Parameters': ['Input'], 'Status': {}, 'AllowedValues': ['On', 'Off']},
            'ExpansionOutputAttenuation': {'Parameters': ['Output'], 'Status': {}},
            'ExpansionOutputMute': {'Parameters': ['Output'], 'Status': {}, 'AllowedValues': ['On', 'Off']},
            ...
            'PlayerControl': {'Parameters': ['Player ID'], 'Status': {}, 'AllowedValues': ['Start', 'Stop']},
            'PlayerFilenameCommand': {'Parameters': ['Player ID'], 'Status': {}},
            'PlayerFilenameStatus': {'Parameters': ['Player ID'], 'Status': {}},
            'PlayerRepeat': {'Parameters': ['Player ID'], 'Status': {}, 'AllowedValues': ['Play Once', 'Repeat']},
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(rb'DsJ(590[0-9]{2})\*([0-9]{1,4})\r\n'), self.__MatchAutomixerGateSet, None)
            self.AddMatchString(re.compile(rb'DsV(590[0-9]{2})\*[10]\*([0-9]{1,4})\*?\d?\r\n'), self.__MatchAutomixerGateStatus, None)  # this accounts for old fw and new fw 1.2 (\*?\d?)
            ...
            self.AddMatchString(re.compile(rb'DsG(4001[2-9])\*([0-9 -]{1,5})\r\n'), self.__MatchAuxInputGain, None)
            self.AddMatchString(re.compile(rb'DsM(4001[2-9])\*([01])\r\n'), self.__MatchAuxInputMute, None)
            self.AddMatchString(re.compile(rb'DsG(4011[2-9])\*([0-9 -]{1,5})\r\n'), self.__MatchAuxInputPremixerGain, None)
            self.AddMatchString(re.compile(rb'DsM(4011[2-9])\*([01])\r\n'), self.__MatchAuxInputPremixerMute, None)
            self.AddMatchString(re.compile(rb'DsG(60008|60009|60010|60011|60012|60013|60014|60015)\*([0-9 -]{1,5})\r\n'), self.__MatchAuxOutputGain, None)
            self.AddMatchString(re.compile(rb'DsM(60008|60009|60010|60011|60012|60013|60014|60015)\*([01])\r\n'), self.__MatchAuxOutputMute, None)
            self.AddMatchString(re.compile(rb'DsG(60108|60109|60110|60111|60112|60113|60114|60115)\*([0-9 -]{1,5})\r\n'), self.__MatchAuxOutputPostmixerTrim, None)
            ...
            self.AddMatchString(re.compile(rb'{dante@([A-Za-z0-9- ]+)}DsG(40000|40001|40002|40003|40004|40005|40006|40007|40008|40009|40010|40011)\*([0-9 -]{1,5})\r\n'), self.__MatchDanteInputGain, None)
            self.AddMatchString(re.compile(rb'{dante@([A-Za-z0-9- ]+)}DsM(40000|40001|40002|40003|40004|40005|40006|40007|40008|40009|40010|40011)\*([01])\r\n'), self.__MatchDanteInputMute, None)
            self.AddMatchString(re.compile(rb'{dante@([A-Za-z0-9- ]+)}DsG(6000[0-7])\*([0-9 -]{1,5})\r\n'), self.__MatchDanteOutputAttenuation, None)
            self.AddMatchString(re.compile(rb'{dante@([A-Za-z0-9- ]+)}DsM(6000[0-7])\*([01])\r\n'), self.__MatchDanteOutputMute, None)
            self.AddMatchString(re.compile(rb'{dante@([A-Za-z0-9- ]+)}GrpmD([0-9]{1,2})\*([0-9 -]{1,5})\r\n'), self.__MatchDanteGroup, None)
            self.AddMatchString(re.compile(rb'{dante@([A-Za-z0-9- ]+)}DsG(40100|40101|40102|40103|40104|40105|40106|40107|40108|40109|40110|40111)\*([0-9 -]{1,5})\r\n'), self.__MatchDantePremixerGain, None)
            self.AddMatchString(re.compile(rb'{dante@([A-Za-z0-9- ]+)}DsG(50100|50101|50102|50103|50104|50105|50106|50107|50108|50109|50110|50111|50112|50113|50114|50115)\*([0-9 -]{1,5})\r\n'), self.__MatchDanteATInputPremixerGain, None)
            self.AddMatchString(re.compile(rb'ExprC([A-Za-z0-9- ]+)\*1\r\n'), self.__MatchDanteConnect, None)
            self.AddMatchString(re.compile(rb'DsH400([01][0-9])\*([0-9 -]{1,5})\r\n'), self.__MatchDigitalInputGain, None)
            self.AddMatchString(re.compile(rb'Gpi([1-8])\*([0-1])\r\n'), self.__MatchDigitalInputStatus, None)
            ...
            self.AddMatchString(re.compile(rb'DsG(502[0-9]{2})\*([0-9 -]{1,5})\r\n'), self.__MatchExpansionInputPremixerGain, None)
            self.AddMatchString(re.compile(rb'DsM(502[0-9]{2})\*([01])\r\n'), self.__MatchExpansionInputPremixerMute, None)
            self.AddMatchString(re.compile(rb'DsG(60016|60017|60018|60019|60020|60021|60022|60023|60024|60025|60026|60027|60028|60029|60030|60031)\*([0-9 -]{1,5})\r\n'), self.__MatchExpansionOutputAttenuation, None)
            self.AddMatchString(re.compile(rb'DsM(60016|60017|60018|60019|60020|60021|60022|60023|60024|60025|60026|60027|60028|60029|60030|60031)\*([01])\r\n'), self.__MatchExpansionOutputMute, None)
            self.AddMatchString(re.compile(rb'DsG(60116|60117|60118|60119|60120|60121|60122|60123|60124|60125|60126|60127|60128|60129|60130|60131)\*([0-9 -]{1,5})\r\n'), self.__MatchExpansionOutputPostmixerTrim, None)
            self.AddMatchString(re.compile(rb'GrpmD([0-9]{1,2})\*([0-9 -]{1,5})\r\n'), self.__MatchGroup, None)

            self.AddMatchString(re.compile(rb'GrpmO(\d{1,2})((:?\*\d{5})+)\r\n'), self.__MatchGroupMeterMember, None)
            self.AddMatchString(re.compile(rb'GrpmV(\d{1,2})((:?\*\d{1,4})+)\r\n'), self.__MatchGroupMeterLevel, None)
            self.AddMatchString(re.compile(rb'GrpuR(\d{1,2})\r\n'), self.__MatchGroupMeterResponseRate, None)
            self.AddMatchString(re.compile(rb'GrpuG(\d{1,2})\r\n'), self.__MatchGroupMeterSelect, None)
            
            self.AddMatchString(re.compile(rb'DsG(40000|40001|40002|40003|40004|40005|40006|40007|40008|40009|40010|40011)\*([0-9 -]{1,5})\r\n'), self.__MatchInputGain, None)
            self.AddMatchString(re.compile(rb'DsM(40000|40001|40002|40003|40004|40005|40006|40007|40008|40009|40010|40011)\*([01])\r\n'), self.__MatchInputMute, None)
            self.AddMatchString(re.compile(rb'DsV(400[01][0-9])\*[01]\*([0-9]{1,4})\*[01]\r\n'), self.__MatchInputSignalLevelMonitor, 'Enabled')
            self.AddMatchString(re.compile(rb'DsJ(400[01][0-9])\*0\r\n'), self.__MatchInputSignalLevelMonitor, 'Disabled')
            self.AddMatchString(re.compile(rb'DsD(400[01][0-9])\*([0-9]{1,2})\r\n'), self.__MatchInputSource, None)
            self.AddMatchString(re.compile(rb'DsG2([0-9]{2})([0-9]{2})\*([0-9 -]{1,5})\r\n'), self.__MatchMixpointGain, None)
            self.AddMatchString(re.compile(rb'DsM2([0-9]{2})([0-9]{2})\*([01])\r\n'), self.__MatchMixpointMute, None)
            self.AddMatchString(re.compile(rb'DsM(6000[0-7])\*([01])\r\n'), self.__MatchOutputMute, None)
            self.AddMatchString(re.compile(rb'DsG(6010[0-7])\*([0-9 -]{1,5})\r\n'), self.__MatchOutputPostmixerTrim, None)
            self.AddMatchString(re.compile(rb'DsG(6000[0-7])\*([0-9 -]{1,5})\r\n'), self.__MatchOutputAttenuation, None)
            self.AddMatchString(re.compile(rb'DsZ4000([0-7])\*([01])\r\n'), self.__MatchPhantomPower, None)
            self.AddMatchString(re.compile(rb'Play([1-8])\*([01])\r\n'), self.__MatchPlayerControl, None)
            self.AddMatchString(re.compile(rb'CplyA([1-8])\*([ \s\S]+?)\r\n'), self.__MatchPlayerFilenameStatus, None)
            self.AddMatchString(re.compile(rb'CplyM([1-8])\*([01])\r\n'), self.__MatchPlayerRepeat, None)
            self.AddMatchString(re.compile(rb'DsG(40100|40101|40102|40103|40104|40105|40106|40107|40108|40109|40110|40111)\*([0-9 -]{1,5})\r\n'), self.__MatchPremixerGain, None)
            self.AddMatchString(re.compile(rb'DsM(40100|40101|40102|40103|40104|40105|40106|40107|40108|40109|40110|40111)\*([01])\r\n'), self.__MatchPremixerMute, None)
            self.AddMatchString(re.compile(rb'DsG(50100|50101|50102|50103|50104|50105|50106|50107|50108|50109|50110|50111|50112|50113|50114|50115)\*([0-9 -]{1,5})\r\n'), self.__MatchVirtualReturnGain, None)
            self.AddMatchString(re.compile(rb'DsM(50100|50101|50102|50103|50104|50105|50106|50107|50108|50109|50110|50111|50112|50113|50114|50115)\*([01])\r\n'), self.__MatchVirtualReturnMute, None)
            ...
            self.AddMatchString(re.compile(rb'{dante@([A-Za-z0-9- ]+)}32Stat([0-3]{5})\*([0-3]{5})\*([0-3]{5})\*([0-3]{5})\*([0-3]{5})\r\n'), self.__MatchFaultStatus, None)
            ...
            self.AddMatchString(re.compile(rb'{dante@([A-Za-z0-9- ]+)}NtfyM1111\*1\r\n'), self.__MatchNotify, None)  # Notify for unsolicited status
