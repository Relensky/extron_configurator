...
DEVICE_INFO = {
    ...
    "models": ["SW2 HD 4K PLUS", "SW4 HD 4K PLUS", "SW6 HD 4K PLUS", "SW8 HD 4K PLUS"],
    "connection": {
        "com_type": "Network",
        "protocol": "SSH",
        "net_port": 22023,
...
class DeviceClass:
    def __init__(self):
        ...
        self.Commands = {
            ...
            'AutoSwitchMode': { 'Status': {}, 'AllowedValues': ['Off', 'User Priority', 'Input Memory Priority']},
            'CECPower': { 'Status': {}, 'AllowedValues': ['On', 'Off']},
