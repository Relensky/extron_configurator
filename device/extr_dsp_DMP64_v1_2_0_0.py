...
class DeviceClass:
    ...
    def __init__(self):
        ...
        self.Commands = {
            ...
            'GroupMute': {'Parameters': ['Group'], 'Status': {}, 'AllowedValues': ['On', 'Off']},
            ...
            'InputMute': {'Parameters': ['Input'], 'Status': {}, 'AllowedValues': ['On', 'Off']},
            'MixpointGain': {'Parameters': ['Input', 'Output'], 'Status': {}},
            'MixpointMute': {'Parameters': ['Input', 'Output'], 'Status': {}, 'AllowedValues': ['On', 'Off']},
            ...
            'VirtualReturnMute': {'Parameters': ['Input'], 'Status': {}, 'AllowedValues': ['On', 'Off']},
        }
